...
A score of 1 corresponds to a fully confidential image, where no information about its content is available while a score of 5 corresponds to an image with no apparent distortion.%, or a high quality image.
...
\begin{subfigure}{4.0cm}
  ...
  \caption{\pbox{2.6cm}{\footnotesize{Euclidean distance of MOS and metric for different thresholds\label{fig:sobsal} }}}
\end{subfigure}%
\begin{subfigure}{4.0cm}
  \centering
  \includegraphics[width=0.95\linewidth]{figures/euclidian_th}
  \caption{\pbox{2.6cm}{\footnotesize{Euclidean distance of MOS and metric for different weights\label{fig:weights} }}}
\end{subfigure}
...
\begin{subfigure}{4.4cm}
  ...
  \caption{\pbox{2.8cm}{\footnotesize{Scores obtained with our metric, sorted on the image distortion MOS\label{fig:results_ss}}}}
\end{subfigure}%
\begin{subfigure}{4.4cm}
  \centering
  \includegraphics[width=0.98\linewidth]{figures/ssim_good_small}
  \caption{\pbox{2.8cm}{\footnotesize{Scores obtained with SSIM, sorted on the image distortion MOS\label{fig:results_ssim}}}}
\end{subfigure}
\caption{Comparison of results for our metric and SSIM\label{fig:scores}}
\end{figure}

\paragraph*{}
% The results we obtained after running our metric on our dataset are available Fig.~\ref{fig:results_ss}, with Fig.~\ref{fig:results_ssim}, the SSIM, for comparison. The correlation of our metric with the MOS of every distortion is $0.9349$ for our metric and $0.9258$ for SSIM and the correlation of our metric with individual image rating is $0.82961$ and $0.8232$ for SSIM.
...
\begin{subfigure}{4.3cm}
  ...
  \caption{\pbox{2.9cm}{\footnotesize{ROC curve of our metric\label{fig:roc_ss} }}}
\end{subfigure}%
\begin{subfigure}{4.3cm}
  \centering
  \includegraphics[width=0.99\linewidth]{figures/roc_ssim}
  \caption{\pbox{2.9cm}{\footnotesize{ROC curve of SSIM\label{fig:roc_ssim} }}}
\end{subfigure}
